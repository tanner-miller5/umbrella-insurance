package com.umbrella.insurance.core.models.teams.v1.db;
...
public class TeamsTableTests {
    ...
    @Test
    @Order(2)
    void insertTeamTest() throws SQLException {
    ...
    @Test
    @Order(3)
    void selectTeamByTeamNameAndLevelOfCompetitionIdAndGameTypeIdTest() throws SQLException {
        Team team1 = teamService.getTeamByTeamNameAndLevelOfCompetitionIdAndGameTypeId(
                teamName, levelOfCompetition.getId(),
                gameType.getId()).get();
    ...
    @Test
    @Order(4)
    void updateTeamByTeamNameAndLevelOfCompetitionIdAndGameTypeIdTest() throws SQLException {
        updatedTeam = teamService.updateTeam(
                    updatedTeam);
    }
    @Test
    @Order(5)
    void selectUpdatedTeamByTeamNameAndLevelOfCompetitionIdAndGameTypeIdTest() throws SQLException {
        Team team1 = teamService.getTeamByTeamNameAndLevelOfCompetitionIdAndGameTypeId(
                updatedTeamName,
    ...
    @Test
    @Order(6)
    void deleteTeamByTeamNameAndLevelOfCompetitionIdAndGameTypeIdTest() throws SQLException {
