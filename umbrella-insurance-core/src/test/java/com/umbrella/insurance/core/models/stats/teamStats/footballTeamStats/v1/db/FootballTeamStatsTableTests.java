package com.umbrella.insurance.core.models.stats.teamStats.footballTeamStats.v1.db;
...
public class FootballTeamStatsTableTests {
    ...
    static {
        ...
        footballTeamStats.setExtraPointAttempts(2l);
        ...
        footballTeamStats.setCompletions(2l);
        ...
        updatedFootballTeamStats.setFumblesRecovered(121l);
        ...
        updatedFootballTeamStats.setLongestKickReturnYards(251l);
        ...
        updatedFootballTeamStats.setNumberOfTimesSacked(331l);
        ...
        // number_of_punts, total_punt_yards, punt_yards_per_punt, touchbacks, in20, longest_punt_yards,
        updatedFootballTeamStats.setNumberOfPunts(371l);
    ...
    @Test
    @Order(2)
    void insertFootballTeamStatsTest() throws SQLException {
        ...
        footballTeamStats = footballTeamStatsService.saveFootballTeamStats(footballTeamStats);
        updatedFootballTeamStats.setId(footballTeamStats.getId());
    }
    @Test
    @Order(3)
    void selectFootballTeamStatsByGameIdAndTeamIdTest() throws SQLException {
        FootballTeamStats footballTeamStats1 = footballTeamStatsService.getFootballTeamStatsByGameIdAndTeamId(
                game.getId(), team.getId()).get();
    ...
    @Test
    @Order(4)
    void updateFootballTeamStatsByGameIdAndTeamIdTest() throws SQLException {
        updatedFootballTeamStats = footballTeamStatsService.updateFootballTeamStats(
                updatedFootballTeamStats);
    }
    @Test
    @Order(5)
    void selectUpdatedFootballTeamStatsByGameIdAndTeamIdTest() throws SQLException {
        FootballTeamStats footballTeamStats1 = footballTeamStatsService.getFootballTeamStatsByGameIdAndTeamId(
                game.getId(), team.getId()).get();
    ...
    @Test
    @Order(6)
    void deleteFootballTeamStatsByGameIdAndTeamIdTest() throws SQLException {
        footballTeamStatsService.deleteFootballTeamStats(
                footballTeamStats.getId());
        ...
        seasonService.deleteSeason(firstSeason.getId());
